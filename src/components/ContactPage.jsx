...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    /*************  ✨ Codeium Command ⭐  *************/
    /**
     * Submits the form data to emailjs to send an email
     * @param {React.FormEvent<HTMLFormElement>} e - The form event
     * @returns {Promise<void>}
     */
    /******  aaf50847-1971-43c7-9973-707a0e1101ea  *******/ e.preventDefault();
    ...
    try {
      const result = await emailjs.send(
        ...
        "template_v5fs36g",
        {
          ...
          to_name: "Abbos",
          to_email: "abbosabdumalikov960@gmail.com",
        },
        "YzZ7Ebu4izMpp6f2C"
      );
  ...
  return (
    <section className="bg-[#fafafa]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-x-[250px] items-center justify-center pt-[40px]">
          <div>
            <img src="/src/assets/Group 33793.png" alt="" className="mx-auto" />
            <p className="text-center font-[600] text-[24px] mt-[20px]">
              Телефон
            </p>
            <p className="text-center font-[500] ">+998 (97) 761 62 51</p>
          </div>
          <div className="">
            <img src="/src/assets/Group 33794.png" alt="" className="mx-auto" />
            <p className="text-center font-[600] text-[24px] mt-[20px]">
              Локация
            </p>
          ...
          <div>
            <img src="/src/assets/Group 33795.png" alt="" className="mx-auto" />
            <p className="text-center font-[600] text-[24px] mt-[20px]">
              Е-майл
            </p>
            <p className="text-center font-[500] ">Sardorraimov@gmail.com</p>
          </div>
        </div>
        <div className="flex gap-x-[250px] items-center justify-center pt-[40px]">
          <div>
            ...
            <p className="text-center font-[500] ">+998 (93) 556 91 31</p>
          </div>
          <div className="">
            <img
              src="/src/assets/image copy 7.png"
              alt=""
              className="mx-auto"
            />
            <p className="text-center font-[600] text-[24px] mt-[20px]">
        ...
        {/* <div className="flex">
          <div className="mt-[120px]">
            ...
            <div>
              <p className="font-[400] mb-[10px] mt-[30px]">Введите имя</p>
              <label>
                <input
                  type="text"
                  className="w-[530px] h-[44px] border-2 border-[#CCCCCC] rounded-[6px]"
                />
              </label>
              <label>
                <p>Email</p>
              ...
              <p className="font-[400] mb-[10px]">Введите номер телефона</p>
              <label>
                <input
                  type="text"
                  className="w-[530px] h-[44px] border-2 border-[#CCCCCC] rounded-[6px]"
              ...
              <p className="font-[400] mb-[10px]">Комментарии</p>
            </div>
            <button
              onClick={handleSubmit}
              className="p-[12px] bg-[#FFB12A] rounded-[8px] text-white font-[500] text-[15px] leading-[15px]"
            >
              Отправить
            </button>
          </div>
          <div className="w-1/2">
            ...
            >
              ...
              <Marker position={position}>
                <Popup>Bu yerda sizning marker malumotlaringiz boladi.</Popup>
              </Marker>
            </MapContainer>
          </div>
        </div> */}
