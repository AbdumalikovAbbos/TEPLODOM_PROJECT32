...
const CategoryCard = () => {
  ...
  const visibleCategories = isCategoryPage
    ? categories
    ...
    <div className="bg-[#FAFAFA]">
      <div className="w-full">
        <header className="max-w-7xl mx-auto px-4 pt-[70px] bg-[#FAFAFA]">
          ...
          {!loading && !error && (
            <div className="pb-[120px] grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-10 mt-8 ">
